...
public class XRelativeLayoutForSoftkeyDetect extends RelativeLayout {
	 ...
	 private static final String TAG = "SoftKeyboardDetect";
	    ...
	    private XISystemContext app = null;

	    public XRelativeLayoutForSoftkeyDetect(Context context, int width, int height) {
	        super(context);
	        screenWidth = width;
	        screenHeight = height;
	        app = (XISystemContext) context;
	    }
	    ...
	    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
	        ...
	        // gone away.
	            ...
	            if (app != null)
	                app.getCurAppView().sendJavascript("cordova.fireDocumentEvent('hidekeyboard');");
	        }
	        // If the height as gotten smaller then we will assume the soft keyboard has 
	        // been displayed.
	        else if (height < oldHeight) {
	            if (app != null)
	            	 app.getCurAppView().sendJavascript("cordova.fireDocumentEvent('showkeyboard');");
	        }
